...
- Configure a book title, creator, page count, format, visual style, scene complexity, search difficulty, and source fidelity.
...
- Export the current book as a print-oriented hardcover PDF with a neutral cover wrap, front-panel-only cover image, landscape intro spread, full landscape Wimmel spreads, and backcover target legend.
